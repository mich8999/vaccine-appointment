    ...
    <section>
        <div class="info">  
            <div class="container content">
                <!-- 嵌入 Google map -->
                <div class="map">
                    <iframe class="map__iframe" src="https://www.google.com/maps/d/u/0/embed?mid=1nTCcKi-cz34fAEgnf9x_e6trvKKL3OOm"></iframe>
                </div>
            ...
            <form class="form" enctype="multipart/form-data" accept="image/png,image/jpeg,image/jpg,image/gif" action="result.php" method="post">
                    ...
                    <div class="input">
                        ...
                        <select class="form-select" aria-label="Default select example" name="hospital">
                            ...
                            <option value="新北市板橋區公所">新北市板橋區公所</option>
                            <option value="新北市三重區公所">新北市三重區公所</option>
                            <option value="新北市中和區公所">新北市中和區公所</option>
                            <option value="新北市永和區公所">新北市永和區公所</option>
                            <option value="新北市新莊區公所">新北市新莊區公所</option>
                            <option value="新北市新店區公所">新北市新店區公所</option>
                            <option value="新北市土城區公所">新北市土城區公所</option>
                            <option value="新北市蘆洲區公所">新北市蘆洲區公所</option>
                            <option value="新北市汐止區公所">新北市汐止區公所</option>
                            <option value="新北市樹林區公所">新北市樹林區公所</option>
                            <option value="新北市鶯歌區公所">新北市鶯歌區公所</option>
                            <option value="新北市三峽區公所">新北市三峽區公所</option>
                            <option value="新北市淡水區公所">新北市淡水區公所</option>
                            <option value="新北市瑞芳區公所">新北市瑞芳區公所</option>
                            <option value="新北市五股區公所">新北市五股區公所</option>
                            <option value="新北市泰山區公所">新北市泰山區公所</option>
                            <option value="新北市林口區公所">新北市林口區公所</option>
                            <option value="新北市八里區公所">新北市八里區公所</option>
                            <option value="新北市深坑區公所">新北市深坑區公所</option>
                            <option value="新北市石碇區公所">新北市石碇區公所</option>
                            <option value="新北市坪林區公所">新北市坪林區公所</option>
                            <option value="新北市三芝區公所">新北市三芝區公所</option>
                            <option value="新北市石門區公所">新北市石門區公所</option>
                            <option value="新北市金山區公所">新北市金山區公所</option>
                            <option value="新北市萬里區公所">新北市萬里區公所</option>
                            <option value="新北市平溪區公所">新北市平溪區公所</option>
                            <option value="新北市雙溪區公所">新北市雙溪區公所</option>
                            <option value="新北市貢寮區公所">新北市貢寮區公所</option>
                            <option value="新北市烏來區公所">新北市烏來區公所</option>
                        </select>
                        <div class="form__item">
