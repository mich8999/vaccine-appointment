    ...
    <section>
        <div class="info">  
            <div class="container content">
                <!-- 嵌入 Google map -->
                <div class="map">
                    <iframe class="map__iframe" src="https://www.google.com/maps/d/u/0/embed?mid=1rvh9jsUYTsldZPT81vCh4jhXttx-yES3" ></iframe>
                </div>
            ...
            <form class="form" enctype="multipart/form-data" accept="image/png,image/jpeg,image/jpg,image/gif" action="result.php" method="post">
                    ...
                    <div class="input">
                        ...
                        <div class="form__item">
                            ...
                            <div class="form__item__box">
                                <input type="tel" name="txtTel" id="" class="form-control" pattern="[0][3][0-9]{8}" placeholder="請輸入03-xxxxxxxx" maxlength="10" required>
                            </div>
                        </div>
                        <div class="form__item">
                        ...
                        <select class="form-select" aria-label="Default select example" name="hospital" required>
                            ...
                            <option value="桃園市桃園區公所">桃園市桃園區公所</option>
                            <option value="桃園市中壢區公所">桃園市中壢區公所</option>
                            <option value="桃園市平鎮區公所">桃園市平鎮區公所</option>
                            <option value="桃園市八德區公所">桃園市八德區公所</option>
                            <option value="桃園市大溪區公所">桃園市大溪區公所</option>
                            <option value="桃園市楊梅區公所">桃園市楊梅區公所</option>
                            <option value="桃園市蘆竹區公所">桃園市蘆竹區公所</option>
                            <option value="桃園市大園區公所">桃園市大園區公所</option>
                            <option value="桃園市龜山區公所">桃園市龜山區公所</option>
                            <option value="桃園市龍潭區公所">桃園市龍潭區公所</option>
                            <option value="桃園市新屋區公所">桃園市新屋區公所</option>
                            <option value="桃園市觀音區公所">桃園市觀音區公所</option>
                            <option value="桃園市復興區公所">桃園市復興區公所</option>
                        </select>
                        <div class="form__item">
